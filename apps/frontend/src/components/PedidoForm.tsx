...
import { PedidoConfirmModal } from './PedidoConfirmModal'; // ✅ Nuevo import
...
export const PedidoForm = ({
  ...
  const [pedidoId, setPedidoId] = useState<number | null>(null); // ✅ estado modal
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      setPedidoId(data.order.id); // ✅ mostrar modal
      clear();
